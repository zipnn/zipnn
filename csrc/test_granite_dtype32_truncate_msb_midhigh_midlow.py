...
slice_length = len(original_bytes[1::4])
zeros = bytearray([0] * slice_length)
original_bytes[1::4] = zeros
...
# byte_mode = 1 [truncate the MSB+MID_HIGH+MID_LOW [0,0,0,1], 80_00_00_001
# is_review = 0 [no review]
# thread = 1 [one thread]
buf1, buf2, buf3, buf4 = split_dtype.split_dtype32(original_bytes, 0, 1, 0 ,1) # bit_mode = 1 [bit_ordering], 
...
combined_bytes = split_dtype.combine_dtype32(buf1, buf2, buf3, buf4, 0, 1, 1)
