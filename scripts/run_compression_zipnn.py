...
from zipnn_file_compression import compress_file
import zipnn
...
def compress_files_with_suffix(
    ...
    with ProcessPoolExecutor(max_workers=max_processes) as executor:
        future_to_file = {
            executor.submit(compress_file, file, dtype, streaming_chunk_size, delete, True): file
        ...
        while future_to_file:
            for future in as_completed(future_to_file):
                ...
                if file_list:
                    ...
                    future_to_file[
                        executor.submit(
                            compress_file, next_file, dtype, streaming_chunk_size, delete, True
                        )
                    ] = next_file
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--force", action="store_true", help="A flag that forces overwriting when compressing."
    )
    parser.add_argument("--max_processes", type=int, help="The amount of maximum processes.")
